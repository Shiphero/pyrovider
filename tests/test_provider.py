...
class ModelSchemataTest(unittest.TestCase):
    maxDiff = None
    service_conf_path = DATA_DIR / "service_conf.yaml"
    app_conf_path = DATA_DIR / "app_conf.yaml"
    ...
    def test_getting_a_service_with_a_config_dependency(self):
        ...
        # Then...
        self.assertEqual(
            {"version": "1", "url": "https://api.some-app.com/v1/"},
    ...
    def test_getting_unknown_service(self):
        ...
        self.assertEqual('"service-unknown" is not a service we know of.', str(context.exception))
    ...
    def test_getting_no_creation_methods(self):
        ...
        self.assertEqual(
            'You must define either a class, an instance, or a factory for the service "service-d", none was found.',
    ...
    def test_getting_too_many_creation_methods(self):
        ...
        self.assertEqual(
            'You must define either a class, an instance, or a factory for the service "service-e", not both.',
            str(context.exception),
        )
    ...
    def test_getting_not_a_service_factory(self):
        ...
        self.assertEqual(
            'The factory class for the service "service-f" does not have a "build" method.',
            str(context.exception),
        )
    ...
    def test_getting_a_service_with_broken_dependencies(self):
        ...
        # Then...
        self.assertEqual(
            'The path "some_app" was not found in the app configuration.',
            str(context.exception),
        )
...
class MockServiceI:
    def __init__(self, some_services_1, some_services_2):
