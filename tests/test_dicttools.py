...
class DictToolsTest(unittest.TestCase):
    ...
    def test_dictwalk(self):
        ...
        d = {
            ...
            "wee": {
                "key": [
                    "Yet another phrase we're going to change.",
                    4,
                    "This one we won't",
                ]
            },
        ...
        self.assertEqual(
            {
                ...
                "wee": {
                    "key": [
                        "Yet another shovel we're going to change.",
                        4,
                        "This one we won't",
                    ]
                },
    ...
    def test_dictpath(self):
        ...
        # Then...
        self.assertEqual(["Yet another phrase we're going to change.", 4, "This one we won't"], v)
